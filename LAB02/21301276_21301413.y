...
parameter_list : parameter_list COMMA type_specifier ID
    ...
    | parameter_list COMMA type_specifier
    {
        ...
        param_info->set_data_type("Variable"); 
        param_info->set_type($3->get_name());   
        sym_table->insert(param_info);  
    ...
    | type_specifier ID
    {
        ...
        param_info->set_data_type("parameter");  
        param_info->set_type($1->get_name());    
        sym_table->insert(param_info);  
...
int main(int argc, char *argv[])
{
	...
	yyin = fopen(argv[1], "r");
	outlog.open("21301276_21301413_outlog.txt", ios::trunc);
